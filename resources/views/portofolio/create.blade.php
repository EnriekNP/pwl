    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('portofolio.store') }}" enctype="multipart/form-data">
            ...
            <div>
                ...
                <x-text-input id="contribution" name="contribution" type="text" class="mt-1 block w-full" required autofocus
            ...
            <div>
                ...
                <x-text-input id="place" name="place" type="text" class="mt-1 block w-full" required autofocus
                    autocomplete="place" />
                <x-input-error class="mt-2" :messages="$errors->get('place')" />
            </div>
            <div>
                <x-input-label for="certificate" :value="__('Certificate')" />
                <x-text-input id="certificate" name="certificate" type="file" class="mt-1 block w-full" required autofocus
